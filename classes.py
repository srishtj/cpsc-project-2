...
class Room:
    ...
    def handle_conditions(self, player):
...
Prepare to start a new life and discover your true purpose.
    ...
    def play_game(self, game_map):
        self.current_room = game_map.get_room('serafiya')
        while True:
    ...
    def handle_dunes_of_damar(self):
    ...
    def handle_temple_of_azar(self):
    ...
    def handle_valley_of_shadows(self):
    ...
    def handle_oasis_of_zafira(self):
    ...
    def handle_ruins_of_al_qamar(self):
